...
const TimKhachSan = () => {
    ...
    const fetchHotels = async (page) => {
        try {
            ...
            const response = await axios.get(`${config.api.url}/api/hotel?currentPage=${page}&pageSize=6`);
                ...
                <Grid item xs={12} md={3}>
                    <Paper elevation={3} sx={{ borderRadius: 5, p: 2 }}>
                        ...
                        <Box sx={{ mb: 3 }}>
                            ...
                            <FormGroup>
                                <FormControlLabel
                                    control={<Checkbox checked={filters.tienIch.hoBoi} onChange={handleTienIchChange("hoBoi")} />}
                                    label="Hồ bơi"
                                />
                                <FormControlLabel
                                    control={<Checkbox checked={filters.tienIch.wifi} onChange={handleTienIchChange("wifi")} />}
                                    label="Wifi miễn phí"
                                />
                                <FormControlLabel
                                    control={<Checkbox checked={filters.tienIch.nhaHang} onChange={handleTienIchChange("nhaHang")} />}
                                    label="Nhà hàng"
                                />
                                <FormControlLabel
                                    control={<Checkbox checked={filters.tienIch.spa} onChange={handleTienIchChange("spa")} />}
                                    label="Spa"
                                />
                            </FormGroup>
                        </Box>
